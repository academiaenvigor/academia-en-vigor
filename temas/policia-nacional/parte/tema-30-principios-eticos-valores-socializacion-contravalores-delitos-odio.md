...
Este bloque fija **ética y moral: conceptos relacionados, no idénticos** con una idea de control: Primero distingue práctica y reflexión; después pregunta si la mayoría aporta razones o solo frecuencia.

- La moral reúne normas, valores, deberes y juicios sobre lo correcto que una persona o comunidad reconoce en la práctica.
- La ética es la reflexión crítica y argumentada sobre la moral, sus fundamentos, sus conflictos y las razones para actuar.
...
Este bloque fija **principios, valores, normas y virtudes** con una idea de control: Pregunta qué función cumple cada pieza: orientar, valorar, prescribir o formar una disposición estable.

- Un principio expresa una orientación general que sirve para justificar reglas y decisiones.
- Un valor identifica algo considerado deseable o digno de protección y orienta preferencias y juicios.
...
Este bloque fija **valores superiores del ordenamiento español** con una idea de control: Memoriza la secuencia literal: libertad, justicia, igualdad y pluralismo político.

- España se constituye en un Estado social y democrático de Derecho.
- El artículo 1.1 de la Constitución propugna como valores superiores la libertad, la justicia, la igualdad y el pluralismo político.
...
Este bloque fija **dignidad, libre desarrollo y respeto a la ley y a los demás** con una idea de control: La libertad personal crece dentro de un marco: dignidad propia, derechos ajenos y ley.

- La dignidad de la persona y los derechos inviolables que le son inherentes son fundamento del orden político y de la paz social.
- El libre desarrollo de la personalidad aparece unido a la dignidad en el artículo 10.1 de la Constitución.
...
Este bloque fija **pluralismo ético y mínimos de convivencia** con una idea de control: Protege el desacuerdo; intervén cuando aparecen daños, coacción o vulneraciones concretas.

- Una sociedad plural admite convicciones morales, religiosas, filosóficas y políticas diferentes dentro del marco de derechos.
- El pluralismo no exige considerar equivalentes todas las afirmaciones ni renunciar a criticarlas con razones.
...
Este bloque fija **concepto de socialización** con una idea de control: Socializar es aprender a vivir con otros sin dejar de interpretar lo aprendido.

- La socialización es el proceso por el que las personas aprenden e interpretan normas, valores, símbolos, roles y pautas de interacción.
- La socialización conecta al individuo con la cultura y facilita la participación en grupos e instituciones.
...
Este bloque fija **socialización primaria, secundaria y resocialización** con una idea de control: Primaria crea la base; secundaria añade mundos; resocialización reordena aprendizajes.

- La socialización primaria se desarrolla principalmente en la infancia y crea aprendizajes básicos mediante vínculos próximos y afectivos.
- La socialización secundaria incorpora roles, saberes y normas de ámbitos específicos como escuela, profesión u organizaciones.
...
Este bloque fija **agentes de socialización** con una idea de control: Localiza quién enseña, qué refuerza y qué grupo ofrece pertenencia en cada caso.

- Familia y cuidadores suelen ser agentes centrales de socialización primaria, sin constituir el único modelo familiar posible.
- La escuela transmite conocimientos, normas de convivencia, roles y experiencias de cooperación y autoridad.
...
Este bloque fija **mecanismos de transmisión de valores** con una idea de control: Los valores se enseñan también con lo que se premia, se permite y se hace delante del grupo.

- Los valores se transmiten mediante lenguaje, ejemplo, identificación, observación, premios, sanciones y participación en prácticas compartidas.
- El modelado permite aprender observando conductas y consecuencias sin ejecutar primero la acción.
...
Este bloque fija **desarrollo moral según kohlberg** con una idea de control: Regla 3×2: tres niveles, dos estadios por nivel; razonamiento no equivale a conducta.

- Kohlberg organizó el desarrollo del razonamiento moral en tres niveles: preconvencional, convencional y postconvencional.
- Cada nivel contiene dos estadios, de modo que el modelo clásico suma seis estadios.
...
Este bloque fija **libertad como autonomía y como derecho** con una idea de control: Libertad no es ausencia total de marco; es capacidad y derecho con garantías.

- La libertad puede describir capacidad de autodeterminación y también posiciones jurídicas protegidas frente a interferencias.
- La autonomía exige poder formar y revisar decisiones, no solo actuar por impulso o bajo presión externa.
...
Este bloque fija **libertad negativa y positiva** con una idea de control: Negativa pregunta quién interfiere; positiva pregunta quién gobierna la decisión.

- La libertad negativa se refiere al ámbito en que una persona puede actuar sin interferencia de otros.
- La libertad positiva se refiere al autogobierno y a la capacidad de ser agente de las propias decisiones.
...
Este bloque fija **responsabilidad moral y responsabilidad jurídica** con una idea de control: No saltes de “está mal” a “es delito”: identifica primero el régimen jurídico.

- La responsabilidad moral valora la acción según deberes, intenciones, consecuencias y capacidad de decisión dentro de un marco ético.
- La responsabilidad jurídica nace de normas y procedimientos que atribuyen consecuencias en ámbitos penal, civil, administrativo o disciplinario.
...
Este bloque fija **libertad, imputación y responsabilidad** con una idea de control: Imputa hechos y decisiones individualizados; no heredes culpas por etiqueta.

- Atribuir responsabilidad presupone normalmente capacidad suficiente para comprender, decidir y actuar, además de una relación con el resultado.
- Cuanto mayor sea la coacción, el error relevante o la incapacidad, más debe examinarse si la imputación se reduce o desaparece.
...
Este bloque fija **igualdad formal y prohibición de discriminación** con una idea de control: Igualdad no es fotocopia: compara situaciones, finalidad, justificación y proporcionalidad.

- El artículo 14 proclama la igualdad de los españoles ante la ley.
- Prohíbe discriminación por nacimiento, raza, sexo, religión, opinión o cualquier otra condición o circunstancia personal o social.
...
Este bloque fija **igualdad real y acción positiva** con una idea de control: La igualdad formal abre la puerta; la igualdad material comprueba si alguien puede cruzarla.

- El artículo 9.2 obliga a los poderes públicos a promover condiciones para que libertad e igualdad sean reales y efectivas.
- También exige remover obstáculos y facilitar la participación de todos en la vida política, económica, cultural y social.
...
Este bloque fija **solidaridad social y constitucional** con una idea de control: Solidaridad no borra diferencias: impide que se conviertan en abandono o privilegio injustificado.

- La solidaridad expresa corresponsabilidad y apoyo entre personas o grupos ante necesidades y riesgos compartidos.
- El artículo 2 de la Constitución reconoce y garantiza la solidaridad entre nacionalidades y regiones.
...
Este bloque fija **solidaridad mecánica y orgánica** con una idea de control: Mecánica une por semejanza; orgánica, por diferencia coordinada e interdependencia.

- Durkheim vinculó la solidaridad mecánica con semejanza, conciencia colectiva intensa y escasa división del trabajo.
- Relacionó la solidaridad orgánica con diferenciación de funciones e interdependencia derivada de una mayor división del trabajo.
...
Este bloque fija **tolerancia: concepto y exigencias** con una idea de control: Tolerar protege a personas y convivencia; no convierte todas las ideas en equivalentes.

- La tolerancia implica respeto, aceptación y aprecio de la diversidad de culturas, expresiones y maneras de ser humanas.
- La UNESCO la relaciona con conocimiento, apertura, comunicación y libertad de pensamiento, conciencia y religión.
...
Este bloque fija **límites y paradoja de la tolerancia** con una idea de control: No uses una sola etiqueta: gradúa idea, contexto, destinatario, daño y relevancia jurídica.

- La tolerancia debe ejercerse de forma compatible con los derechos humanos y no puede invocarse para justificar su vulneración.
- No obliga a tolerar injusticia social ni a abandonar convicciones, pero exige que cada persona sea libre de mantener las propias y aceptar igual libertad ajena.
...
Este bloque fija **contravalores y reacción frente a valores mayoritarios** con una idea de control: Mayoría indica cantidad, no corrección; busca el derecho o daño concreto.

- Un contravalor designa una orientación considerada opuesta a un valor de referencia, pero su identificación depende del marco normativo y cultural empleado.
- La desaprobación mayoritaria no basta para convertir una conducta en ilícita o éticamente incorrecta.
...
Este bloque fija **racismo: concepto** con una idea de control: Busca la jerarquía y la racialización, no solo la palabra raza.

- El racismo atribuye valor, capacidad, superioridad o inferioridad a personas o grupos mediante categorías racializadas u orígenes.
- Puede apoyarse en supuestas diferencias biológicas o trasladarse a cultura, nacionalidad, lengua, religión u origen como fronteras rígidas.
...
Este bloque fija **racismo biológico y racismo cultural** con una idea de control: Biológico fija por herencia; cultural fija por esencia: ambos pueden construir jerarquía.

- El racismo biológico presenta diferencias humanas como naturales, hereditarias y determinantes para justificar jerarquías.
- El racismo cultural convierte rasgos culturales en esencias fijas e incompatibles y puede legitimar exclusión sin hablar de biología.
...
Este bloque fija **racismo simbólico, moderno y aversivo** con una idea de control: Lo sutil no es invisible: compara criterios, contexto y aplicación selectiva.

- Las formas sutiles de racismo pueden rechazar el prejuicio abierto y, a la vez, negar desventajas o resistir medidas de igualdad.
- El racismo simbólico expresa resentimiento mediante valores aparentemente neutrales aplicados selectivamente a grupos racializados.
...
Este bloque fija **discriminación racial directa e indirecta** con una idea de control: Mira efecto, comparación y motivo; la neutralidad del texto no garantiza neutralidad del resultado.

- La discriminación directa trata de manera menos favorable a una persona o grupo por una causa protegida en situación comparable.
- La discriminación indirecta nace de una disposición, criterio o práctica aparentemente neutros que ocasionan una desventaja particular.
...
Este bloque fija **prevención del racismo y acción institucional** con una idea de control: Mide patrones para corregir sistemas, no para convertir el grupo en sospechoso.

- La respuesta antirracista combina prevención, educación, igualdad de trato, detección, protección de víctimas, sanción y reparación.
- Las acciones positivas pueden compensar desventajas estructurales si son razonables, proporcionadas y temporales mientras subsistan.
...
Este bloque fija **fanatismo: concepto** con una idea de control: Firmeza acepta razones y límites; fanatismo convierte la causa en permiso total.

- El fanatismo implica apasionamiento y tenacidad desmedidos en la defensa de creencias u opiniones, especialmente religiosas o políticas.
- La intensidad de una convicción no basta por sí sola: importan rigidez, intolerancia a la crítica y subordinación de otros bienes.
...
Este bloque fija **polarización, identidad y pensamiento fanático** con una idea de control: Factores de riesgo no son destino: analiza trayectoria, contexto, intención y capacidad.

- La fusión entre identidad personal y causa puede hacer que una crítica a la idea se viva como ataque total a la persona o al grupo.
- El pensamiento dicotómico reduce problemas complejos a bandos puros y enemigos absolutos.
...
Este bloque fija **fundamentalismo: origen y uso actual** con una idea de control: No conviertas una palabra histórica en un saco único para religión, rigidez y terrorismo.

- El término fundamentalismo nació vinculado a movimientos protestantes estadounidenses defensores de fundamentos doctrinales a comienzos del siglo XX.
- Su uso se amplió para describir lecturas rígidas y pretensiones de retorno a fundamentos considerados inalterables en diversas tradiciones.
...
Este bloque fija **fundamentalismo, integrismo y extremismo violento** con una idea de control: Separa doctrina, proyecto político, aceptación de violencia y delito probado.

- El integrismo suele aludir a la pretensión de ordenar de forma íntegra la vida social o política conforme a una doctrina.
- El extremismo violento incorpora aceptación, apoyo o uso de violencia para fines ideológicos; no toda posición extrema cruza ese umbral.
...
Este bloque fija **prevención: pensamiento crítico, pertenencia y alternativas** con una idea de control: Ofrece razones, vínculos y salida; no regales al grupo una prueba de su relato persecutorio.

- El pensamiento crítico contrasta fuentes, identifica simplificaciones y permite revisar creencias sin humillar a quien las sostenía.
- La pertenencia prosocial y los vínculos de confianza ofrecen alternativas a grupos que monopolizan identidad y apoyo.
...
Este bloque fija **secta: término y neutralidad jurídica** con una idea de control: Investiga conductas, no rareza doctrinal ni tamaño del grupo.

- Secta puede usarse en sociología para grupos religiosos separados de una tradición o, en lenguaje común, con sentido peyorativo.
- Una minoría religiosa o ideológica no es ilícita ni dañina por el hecho de ser pequeña, nueva o poco conocida.
...
Este bloque fija **grupo de control coercitivo o destructivo** con una idea de control: Cambia la pregunta “qué creen” por “cómo controlan, qué daño producen y si se puede salir”.

- La noción de grupo de control coercitivo centra el análisis en prácticas de dominación, dependencia y explotación, no en la doctrina concreta.
- El control puede combinar aislamiento, vigilancia, agotamiento, miedo, culpa, presión económica y monopolio de información.
...
Este bloque fija **persuasión, influencia y manipulación** con una idea de control: Distingue argumento, engaño, dependencia y amenaza; no los metas en el mismo cajón.

- Persuadir ofrece razones o estímulos para cambiar una decisión; manipular oculta o distorsiona elementos relevantes para controlar la respuesta.
- La influencia social es inevitable y no equivale automáticamente a coacción.
...
Este bloque fija **captación y escalada de compromiso** con una idea de control: La trampa suele estrecharse paso a paso; no culpes a quien no vio el final desde la entrada.

- La captación puede comenzar con apoyo, identidad y objetivos atractivos sin revelar desde el inicio todas las exigencias.
- El compromiso gradual aumenta costes de salida mediante tiempo, dinero, vínculos, confesiones o ruptura de relaciones externas.
...
Este bloque fija **autoridad carismática, liderazgo y obediencia** con una idea de control: Carisma explica la fuente de legitimidad; abuso exige hechos adicionales de poder y control.

- La autoridad carismática se apoya en la atribución de cualidades extraordinarias a una persona y en el reconocimiento de seguidores.
- Puede facilitar movilización rápida y lealtad intensa, pero no convierte todo liderazgo carismático en sectario.
...
Este bloque fija **aislamiento, información y lenguaje cerrado** con una idea de control: El indicador gana peso cuando cierra contraste, castiga duda y aumenta dependencia.

- El aislamiento reduce contraste externo y puede aumentar dependencia del grupo para identidad, información y apoyo.
- Un lenguaje propio puede reforzar pertenencia; se vuelve preocupante cuando bloquea preguntas y convierte toda crítica en prueba de enemistad.
...
Este bloque fija **clasificación de bryan wilson i** con una idea de control: Clasifica la respuesta al mundo, no la peligrosidad penal.

- Las sectas conversionistas buscan una transformación interior radical del individuo como respuesta principal al mundo.
- Las revolucionarias esperan una transformación inminente del orden existente mediante intervención sobrenatural.
...
Este bloque fija **clasificación de bryan wilson ii** con una idea de control: Taumatúrgica recuerda prodigio; reformista cambia; utópica reconstruye.

- Las manipulacionistas buscan dominar técnicas o conocimientos especiales para alcanzar fines dentro del mundo.
- Las taumatúrgicas se orientan a intervención extraordinaria, curación, oráculos o fenómenos sobrenaturales.
...
Este bloque fija **riesgos jurídicos asociados, no delitos por etiqueta** con una idea de control: La creencia se protege; el delito se prueba.

- Una organización puede ser investigada por estafa, coacciones, amenazas, lesiones, trata, explotación, delitos sexuales u otros hechos concretos.
- Las asociaciones que persigan fines o utilicen medios tipificados como delito son ilegales conforme al artículo 22.2 de la Constitución.
...
Este bloque fija **atención policial y salida segura** con una idea de control: Ayuda a salir del control sin convertir la vergüenza en una segunda jaula.

- La primera atención debe evitar ridiculizar creencias o responsabilizar a la víctima por haber ingresado en el grupo.
- La salida puede aumentar riesgo de amenazas, pérdida económica, ruptura familiar o exposición de información íntima.
...
Este bloque fija **hooliganismo: concepto y delimitación** con una idea de control: Identidad deportiva no es delito; describe la conducta, el vínculo con el evento y la norma.

- Hooliganismo designa violencia, desórdenes o intimidación vinculados a determinados grupos de seguidores, especialmente en el fútbol.
- No todo aficionado intenso, peña, grupo ultra o desplazamiento colectivo constituye hooliganismo.
...
Este bloque fija **identidad, masculinidad y búsqueda de confrontación** con una idea de control: Explicar no es justificar: conecta trayectoria social, grupo y decisión individual.

- La Escuela de Leicester estudió el hooliganismo como fenómeno social e histórico, no como simple suma de individuos desviados.
- Analizó vínculos entre identidad masculina, honor grupal, rivalidad, control emocional y segmentos sociales concretos.
...
Este bloque fija **enfoque de la escuela de leicester** con una idea de control: Leicester mira procesos e interdependencias; no una etiqueta instantánea.

- Dunning y colaboradores aplicaron la sociología figuracional de Norbert Elias al deporte y a la violencia de espectadores.
- El enfoque atiende a redes de interdependencia, autocontrol, historia comunitaria y transformación del fútbol.
...
Este bloque fija **enfoque etogénico de peter marsh** con una idea de control: Ritual explica reglas del enfrentamiento; no borra el riesgo cuando esas reglas fallan.

- El enfoque etogénico de Peter Marsh interpretó parte de la confrontación entre aficionados como agresión ritualizada.
- Las reglas informales, gestos y fronteras territoriales pueden ordenar el enfrentamiento y limitarlo en determinadas situaciones.
...
Este bloque fija **enfoque marxista de ian taylor** con una idea de control: Trampa clásica: Taylor = resistencia obrera frente al fútbol aburguesado.

- Ian Taylor interpretó el hooliganismo como manifestación de resistencia de sectores obreros ante la transformación del fútbol.
- Su análisis destacó el aburguesamiento, profesionalización, comercialización e internacionalización que alejaban el club de vínculos locales tradicionales.
...
Este bloque fija **dinámica del evento y escalada** con una idea de control: Gestiona condiciones de escalada sin convertir factores de riesgo en culpabilidad.

- La rivalidad previa, el anonimato grupal, rumores, alcohol, espacio, transporte y actuación de líderes pueden modificar el riesgo de escalada.
- Ningún factor aislado determina violencia y algunos, como edad o procedencia, no justifican perfiles automáticos.
...
Este bloque fija **conductas violentas en la ley 19/2007** con una idea de control: Recinto, aledaños, transporte, mensaje y apoyo material forman un perímetro más amplio que el césped.

- El artículo 2.1 incluye altercados, riñas, peleas o desórdenes vinculados al acontecimiento en recintos, aledaños o transportes organizados.
- Incluye pancartas, símbolos, emblemas, leyendas o cánticos que inciten a violencia, terrorismo o agresión en los términos legales.
...
Este bloque fija **racismo, xenofobia e intolerancia en el deporte** con una idea de control: El soporte cambia; la dignidad, el motivo y el contexto deciden la relevancia.

- El artículo 2.2 comprende amenazas, insultos o vejaciones difundidos por motivos raciales, étnicos, geográficos, sociales, religiosos y otras causas protegidas.
- Incluye acoso que atente contra la dignidad y cree un entorno intimidatorio, humillante u ofensivo.
...
Este bloque fija **obligaciones de organizadores y cooperación** con una idea de control: La prevención comienza antes del torno: información, apoyo, desplazamiento y cese inmediato.

- Las personas organizadoras deben adoptar medidas para evitar conductas violentas, racistas, xenófobas o intolerantes y garantizar condiciones de acceso y permanencia.
- Deben colaborar con autoridades, facilitar información sobre grupos y desplazamientos y ayudar a identificar infractores.
...
Este bloque fija **oficina nacional de deportes y coordinación de seguridad** con una idea de control: Actualización de examen: Brigada de Coordinación Operativa, Seguridad Ciudadana.

- La Oficina Nacional de Deportes depende actualmente de la Brigada de Coordinación Operativa de la Comisaría General de Seguridad Ciudadana.
- Coordina y apoya a los coordinadores de seguridad en acontecimientos deportivos.
...
Este bloque fija **delito de odio: estructura de dos elementos** con una idea de control: Fórmula de control: delito base + selección o motivación prejuiciosa.

- Un delito de odio combina una infracción penal de base con una motivación de prejuicio relacionada con una característica protegida.
- La víctima, persona o bien es seleccionada por su conexión real o percibida con un grupo o característica.
...
Este bloque fija **delito de odio, discurso de odio e incidente de odio** con una idea de control: Registro operativo no es condena; conserva indicios para que la calificación se decida con prueba.

- Delito de odio y discurso de odio se solapan en algunos casos, pero no son categorías idénticas.
- Un delito común motivado por prejuicio puede ser delito de odio aunque no incluya expresión pública.
...
Este bloque fija **indicadores de polarización o sesgo** con una idea de control: Indicador abre una línea de investigación; prueba contrastada sostiene la conclusión.

- Los indicadores de polarización son señales que ayudan a detectar una posible motivación de prejuicio y orientan la investigación.
- Pueden incluir percepción de la víctima, expresiones del autor, símbolos, diferencias identitarias relevantes, fechas, lugar, selección y antecedentes.
...
Este bloque fija **agravante discriminatoria del código penal** con una idea de control: Memoriza causas y cierre: importa el motivo, aunque la característica percibida no sea real.

- El artículo 22.4 agrava cometer el delito por motivos racistas, antisemitas, antigitanos u otra discriminación basada en las causas que enumera.
- Incluye ideología, religión o creencias; etnia, raza o nación; sexo, edad, orientación o identidad sexual o de género y razones de género.
...
Este bloque fija **incitación, materiales y negacionismo del artículo 510.1** con una idea de control: En el 510 importa verbo, publicidad, idoneidad, grupo o persona y motivo protegido.

- El artículo 510.1.a castiga fomentar, promover o incitar públicamente, directa o indirectamente, al odio, hostilidad, discriminación o violencia contra grupos o personas por motivos protegidos.
- El apartado 1.b alcanza producción, posesión para distribuir, acceso, distribución, difusión o venta de materiales idóneos para esa promoción o incitación.
...
Este bloque fija **dignidad, justificación pública y agravaciones del artículo 510** con una idea de control: No memorices “internet = delito”; primero tipo, luego difusión y agravación.

- El artículo 510.2.a sanciona lesiones a la dignidad mediante humillación, menosprecio o descrédito graves de grupos o personas por motivos protegidos.
- El artículo 510.2.b contempla enaltecer o justificar públicamente delitos cometidos contra grupos o personas por esos motivos.
...
Este bloque fija **denegación discriminatoria de prestaciones** con una idea de control: Primero identifica quién presta, si existe derecho y cuál es el motivo de la negativa.

- El artículo 511 se refiere a denegación discriminatoria de una prestación a la que se tiene derecho por el particular encargado de un servicio público.
- Si los hechos del artículo 511 los comete un funcionario público, se aplican las penas previstas en su mitad superior y la inhabilitación correspondiente.
...
Este bloque fija **víctimas, infradenuncia y victimización secundaria** con una idea de control: La tardanza puede ser un dato del daño, no una prueba automática contra la víctima.

- La infradenuncia puede relacionarse con miedo, vergüenza, normalización, desconfianza, dependencia, barreras lingüísticas o temor a revelar identidad o situación.
- La primera respuesta debe informar, escuchar, valorar riesgo y evitar juicios sobre la identidad o conducta de la víctima.
...
Este bloque fija **investigación policial, registro y ciberodio** con una idea de control: Conserva contexto y trazabilidad digital; el medio amplifica, pero no sustituye el tipo penal.

- El atestado debe recoger de forma expresa indicadores de polarización, manifestaciones, símbolos, contexto y percepción de la víctima relevantes.
- La investigación debe preservar mensajes, perfiles, URLs, fechas, metadatos, alcance y cadena de custodia sin limitarse a una captura aislada.
...
Este bloque fija **organización institucional frente a los delitos de odio** con una idea de control: Tres planos: coordinación estatal, interlocución social e investigación del caso.

- La Dirección General de Coordinación y Estudios dirige la Oficina Nacional de lucha contra los delitos de odio.
- La Oficina coordina y da seguimiento a la respuesta estatal, pero no sustituye las competencias de investigación de Policía Nacional y Guardia Civil ni la función judicial.
