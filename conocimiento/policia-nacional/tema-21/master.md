...
> Corte normativo: 2026-08-02. Redacción propia desde fuentes oficiales.

<!-- BLOCK 01 START -->
## 1. Derecho procesal penal y proceso
**Fuente principal:** `LECRIM-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-01-derecho-procesal-penal-y-proceso.webp` · Derecho procesal penal y proceso.
:::
...
:::visual
**Referencia visual prevista:** `t21-02-jurisdiccion-penal.webp` · Jurisdicción penal.
:::
...
<!-- BLOCK 03 START -->
## 3. Competencia: concepto y criterios
**Fuente principal:** `LECRIM-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-03-competencia-concepto-y-criterios.webp` · Competencia: concepto y criterios.
:::
...
<!-- BLOCK 04 START -->
## 4. Fueros territoriales y delitos conexos
**Fuente principal:** `LECRIM-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-04-fueros-territoriales-y-delitos-conexos.webp` · Fueros territoriales y delitos conexos.
:::
...
<!-- BLOCK 05 START -->
## 5. Órganos penales territoriales
**Fuente principal:** `LOPJ-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-05-organos-penales-territoriales.webp` · Órganos penales territoriales.
:::
...
<!-- BLOCK 06 START -->
## 6. Audiencia Nacional y Tribunal Central
**Fuente principal:** `LOPJ-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-06-audiencia-nacional-y-tribunal-central.webp` · Audiencia Nacional y Tribunal Central.
:::
...
:::visual
**Referencia visual prevista:** `t21-07-denuncia-concepto-y-efectos.webp` · Denuncia: concepto y efectos.
:::
...
<!-- BLOCK 08 START -->
## 8. Forma e identificación de la denuncia
**Fuente principal:** `LECRIM-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-08-forma-e-identificacion-de-la-denuncia.webp` · Forma e identificación de la denuncia.
:::
...
<!-- BLOCK 09 START -->
## 9. Obligación general de denunciar
**Fuente principal:** `LECRIM-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-09-obligacion-general-de-denunciar.webp` · Obligación general de denunciar.
:::
...
:::visual
**Referencia visual prevista:** `t21-10-exenciones-del-deber-de-denunciar.webp` · Exenciones del deber de denunciar.
:::
...
:::visual
**Referencia visual prevista:** `t21-11-detencion-concepto-y-presupuesto.webp` · Detención: concepto y presupuesto.
:::
...
:::visual
**Referencia visual prevista:** `t21-12-detencion-por-particulares.webp` · Detención por particulares.
:::
...
:::visual
**Referencia visual prevista:** `t21-13-obligacion-policial-de-detener.webp` · Obligación policial de detener.
:::
...
:::visual
**Referencia visual prevista:** `t21-14-duracion-y-puesta-en-libertad-o-a-disposic.webp` · Duración y puesta en libertad o a disposición.
:::
...
:::visual
**Referencia visual prevista:** `t21-15-informacion-silencio-y-no-autoincriminacio.webp` · Información, silencio y no autoincriminación.
:::
...
:::visual
**Referencia visual prevista:** `t21-16-asistencia-letrada-y-comunicaciones.webp` · Asistencia letrada y comunicaciones.
:::
...
:::visual
**Referencia visual prevista:** `t21-17-extranjeros-interprete-salud-y-accesibilid.webp` · Extranjeros, intérprete, salud y accesibilidad.
:::
...
:::visual
**Referencia visual prevista:** `t21-18-menores-y-personas-vulnerables.webp` · Menores y personas vulnerables.
:::
...
**Fuente principal:** `INT-1-2024-T21`
<!-- PARTE START -->
...
:::visual
**Referencia visual prevista:** `t21-19-procedimiento-integral-de-detencion-polici.webp` · Procedimiento integral de detención policial.
:::
...
:::visual
**Referencia visual prevista:** `t21-20-uso-de-la-fuerza-cacheo-y-custodia.webp` · Uso de la fuerza, cacheo y custodia.
:::
...
:::visual
**Referencia visual prevista:** `t21-21-detencion-incomunicada-y-terrorismo.webp` · Detención incomunicada y terrorismo.
:::
...
:::visual
**Referencia visual prevista:** `t21-22-habeas-corpus-detencion-ilegal.webp` · Habeas corpus: detención ilegal.
:::
...
:::visual
**Referencia visual prevista:** `t21-23-habeas-corpus-legitimacion-y-juez-competen.webp` · Habeas corpus: legitimación y juez competente.
:::
...
:::visual
**Referencia visual prevista:** `t21-24-habeas-corpus-tramitacion-y-resolucion.webp` · Habeas corpus: tramitación y resolución.
:::
...
:::visual
**Referencia visual prevista:** `t21-25-ministerio-fiscal-naturaleza-y-principios.webp` · Ministerio Fiscal: naturaleza y principios.
:::
...
:::visual
**Referencia visual prevista:** `t21-26-funciones-e-investigacion-del-ministerio-f.webp` · Funciones e investigación del Ministerio Fiscal.
:::
...
:::visual
**Referencia visual prevista:** `t21-27-policia-judicial-mision.webp` · Policía Judicial: misión.
:::
...
:::visual
**Referencia visual prevista:** `t21-28-policia-judicial-composicion-y-unidades.webp` · Policía Judicial: composición y unidades.
:::
...
:::visual
**Referencia visual prevista:** `t21-29-secuencia-policial-y-trampas-de-examen.webp` · Secuencia policial y trampas de examen.
:::
...
El contenido se desarrolla en 29 bloques semánticos sincronizados con El Parte y El Atestado.
